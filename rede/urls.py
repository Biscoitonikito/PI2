...
urlpatterns = [
    ...
    path('posts/<int:pk>/comments/', views.CommentList.as_view(), name=views.CommentList.name),
    path('posts/<int:pk>/comments/<int:pk2>/', views.CommentDetail.as_view(), name=views.CommentDetail.name),
